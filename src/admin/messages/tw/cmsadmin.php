...
return [
    ...
    'view_index_add_type' => '頁面類型',
    'view_index_type_page' => '頁面',
    'view_index_type_module' => '模組',
    'view_index_type_redirect' => '轉發',
    'view_index_as_draft' => '作為樣板',
    'view_index_as_draft_help' => '你想要將新頁面定義為樣板嗎？',
    'view_index_no' => '否',
    'view_index_yes' => '是',
    'view_index_page_title' => '頁面標題',
    'view_index_page_alias' => 'URL路徑段',
    'view_index_page_meta_description' => '描述',
    'view_index_page_nav_container' => '導航容器',
    'view_index_page_parent_page' => '父頁面',
    'view_index_page_success' => '成功新增頁面',
    'view_index_page_parent_root' => '在根目錄',
    'view_index_page_use_draft' => '是否使用樣板？',
